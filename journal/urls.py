...
urlpatterns = [
    ...
    url(r'^entry_form/(?P<activity_id>[0-9]+)/(?P<entry_type>[#aegiklmntx]+)/$', views.entry_form, name='entry_form'),
    url(r'^entry_form/(?P<activity_id>[0-9]+)/(?P<entry_type>[#aegiklmntx]+)/(?P<entry_pk>[0-9]+)/', views.entry_form, name='entry_form'),
