    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advisor_phone', models.CharField(validators=[django.core.validators.RegexValidator(regex='^\\+?1?\\d{9,15}$', message="Phone number must be entered in the format:                                 '+999999999'. Up to 15 digits allowed.")], max_length=15, null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_entry', models.ImageField(upload_to='', blank=True, storage=django.core.files.storage.FileSystemStorage(location='/home/leekevin/iU/media'))),
