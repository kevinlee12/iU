...
echo "SOCIAL_AUTH_GOOGLE_OAUTH2_KEY='<Client Key>'" >> $ENV_ACTIVATE_FILE
echo "export SOCIAL_AUTH_GOOGLE_OAUTH2_KEY" >> $ENV_ACTIVATE_FILE
echo "SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET='<Secret Key>'" >> $ENV_ACTIVATE_FILE
echo "export SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET" >> $ENV_ACTIVATE_FILE
echo "...done"
echo "Setting keys for Cloudinary..."
echo "export CLOUDINARY_URL='<Cloudinary URL>'"
